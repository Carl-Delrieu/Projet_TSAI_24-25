...
def main():
    ...
    # Get images
    train_images, test_images = get_images_data(trim=3000)
    import numpy as np
    print("Shape of first few train images:")
    ...
    print("Shape of first few test images:")
    ...
    for model_name, model in model_dict.items():
        ...
        torch.save(model.state_dict(), f"{model_name}_trained_model.pth")
        print(f"Model {model_name} saved to {model_name}_trained_model.pth")
